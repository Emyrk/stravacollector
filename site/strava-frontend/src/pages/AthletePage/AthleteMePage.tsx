    ...
    <Stack spacing={0.5}>
      <Alert status={load.last_load_complete ? "success" : "warning"}>
        ...
        {load.last_load_complete
          ...
          : "Not all historical activities have been loaded. Loading starts with the oldest activity, and walks forward in time. Please be patient, as Strava has rate limits on how quickly these can be retrieved."
          }
